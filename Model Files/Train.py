import os
import pandas as pd
from sklearn.model_selection import train_test_split #for test-train data splitting
...
#code for loading the dataset and preprocessing
image_folder = "C:/Users/rahul/Desktop/Final Aml Project/Model Files/Test_Data"
...
for label in os.listdir(image_folder):
    ...
    for img_name in os.listdir(label_dir):
        ...
        results = model_yolo.predict(img_path, show_boxes=False, verbose=False)
        for r in results:
...
torch.save(model.state_dict(), 'YogaClass.pth')
